<%-- 
    ...
    Created on : 13-dic-2020, 0:51:41
    Author     : NYXTH
--%>
...
<body>
    ...
    <%                //String IdTipoUsuario= request.getParameter("IdTipoUsuario");
                     ...
                     System.out.println("JSP EDITAR Categoria:");
                      System.out.println("id de Categoria:  "+request.getAttribute("idCategoria"));
                        System.out.println("Nombre de Categoria  "+request.getAttribute("NombreCategoria"));
            ...
            <div class="container-xl "  style="margin-top: 150px; border: 0px solid black;margin-left:50px;margin-right:50px; top: 500px;">
                ...
                <div class="row justify-content-md-center " id="Container"style="">
                    <div class="col-xl PanelHeader"  id="ContainerHeader" >
                        ...
                        <h4>Categoria a Editar: <%out.print(request.getAttribute("NombreComercial"));%></h4>
                         ...
                         <div class="row">
                                        <div class="col-lg-12">
                                            <div class="table-responsive">        
                                                ...
                                                <form  method="POST" action="/WebApplication_inventory_process_control/local">
                                                    
                                                     <div class="form-group">
                                                          <label for="TipoUsuarioForm">Identificador</label>
                                                          <input  class="form-control" value="<%out.print(request.getAttribute("idLocal"));%>" name="id" readonly>
                                                          
                                                      </div>
                                                    
                                                     <div class="form-group">
                                                          <label for="TipoUsuarioForm">Rut Local</label>
                                                          <input  class="form-control" value="<%out.print(request.getAttribute("rutLocal"));%>" name="txtRutLocal" readonly>
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <input type="text" class="form-control" placeholder="<% out.print(request.getAttribute("DigitoVerificador")); %>" name="txtDigitoVerificadorLocal" readonly>

                                                    </div>
                                                      <div class="form-group">
                                                          <label for="TipoUsuarioForm">Nombre Comercial</label>
                                                          <input  class="form-control" value="<%out.print(request.getAttribute("NombreComercial"));%>" name="txtNombreComercial" >
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <input type="text" class="form-control" value="<% out.print(request.getAttribute("RazonSocial")); %>" placeholder="<% out.print(request.getAttribute("RazonSocial")); %>" name="txtRazonSocial">
