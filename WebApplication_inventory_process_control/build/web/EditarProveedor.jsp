<%-- 
    ...
    Created on : 12-dic-2020, 17:29:00
    Author     : NYXTH
--%>
...
<body>
    ...
    <%                //String IdTipoUsuario= request.getParameter("IdTipoUsuario");
                     ...
                     System.out.println("JSP EDITAR Categoria:");
                     System.out.println("id de Categoria:  "+request.getAttribute("idProveedor"));
                     System.out.println("Nombre de Categoria  "+request.getAttribute("nombreProveedor"));
                     System.out.println("id de Categoria:  "+request.getAttribute("apellidoPaterno"));
                     System.out.println("Nombre de Categoria  "+request.getAttribute("apellidoMaterno"));
                     System.out.println("id de Categoria:  "+request.getAttribute("nombreComercial"));
                     System.out.println("Nombre de Categoria  "+request.getAttribute("razonSocial"));
            ...
            <div class="container-xl "  style="margin-top: 150px; border: 0px solid black;margin-left:50px;margin-right:50px; top: 500px;">
                ...
                <div class="row justify-content-md-center " id="Container"style="">
                    <div class="col-xl PanelHeader"  id="ContainerHeader" >
                        ...
                        <h4>Proveedor a Editar: <%out.print(request.getAttribute("nombreProveedor")); %></h4>
                         ...
                         <div class="row">
                                        <div class="col-lg-12">
                                            <div class="table-responsive">        
                                                ...
                                                <form  method="POST" action="/WebApplication_inventory_process_control/Proveedor">
                                                    
                                                    
                                                     <div class="form-group">
                                                          <label for="TipoUsuarioForm">Identificador</label>
                                                          <input  class="form-control" value="<%out.print(request.getAttribute("idProveedor"));%>" name="id" readonly>
                                                          
                                                      </div>
                                                          
                                                    <div class="form-group">
                                                        
                                                      <label for="TipoUsuarioForm">Rut:</label>
                                                        <input type="text" class="form-control " placeholder="<% out.print(request.getAttribute("rutProveedor")); %>" value="<% out.print(request.getAttribute("rutProveedor")); %>" name="txtRut" readonly>

                                                    </div>
                                                                                             
                                                    <div class="form-group">
                                                        
                                                      <label for="TipoUsuarioForm">Digito Verificador:</label>
                                                      <input type="text" class="form-control" placeholder="<% out.print(request.getAttribute("digitoVerfiicador")); %>" value="<% out.print(request.getAttribute("digitoVerfiicador")); %>" name="txtDigiteRut" readonly>

                                                    </div>
                                                                                             
                                                    <div class="form-group">
                                                        
                                                      <label for="TipoUsuarioForm">Nombres:</label>
                                                      <input type="text" class="form-control" placeholder="<% out.print(request.getAttribute("nombreProveedor")); %>" value="<% out.print(request.getAttribute("nombreProveedor")); %>" name="txtName">

                                                    </div>
                                                                                             
                                                    <div class="form-group">
                                                        
                                                      <label for="TipoUsuarioForm">Apellido Paterno:</label>
                                                      <input type="text" class="form-control" placeholder="<% out.print(request.getAttribute("apellidoPaterno")); %>" value="<% out.print(request.getAttribute("apellidoPaterno")); %>" name="txtLastName">

                                                    </div>
                                                                                             
                                                    <div class="form-group">
                                                        
                                                      <label for="TipoUsuarioForm">Apellido Materno:</label>
                                                      <input type="text" class="form-control" placeholder="<% out.print(request.getAttribute("apellidoMaterno")); %>" value="<% out.print(request.getAttribute("apellidoMaterno")); %>" name="txtMotherLastName">

                                                    </div>
                                                                                             
                                                    <div class="form-group">
                                                        
                                                      <label for="TipoUsuarioForm">Direccion:</label>
                                                      <input type="text" class="form-control" placeholder="<% out.print(request.getAttribute("direccionProveedor")); %>" value="<% out.print(request.getAttribute("direccionProveedor")); %>" name="txtAdress">

                                                    </div>
                                                                                             
                                                    <div class="form-group">
                                                        
                                                      <label for="TipoUsuarioForm">Nombre Comercial:</label>
                                                      <input type="text" class="form-control" placeholder="<% out.print(request.getAttribute("nombreComercial")); %>" value="<%out.print(request.getAttribute("nombreComercial"));%>" name="txtNameCommerce">

                                                    </div>
                                                                                             
                                                    <div class="form-group">
                                                        
                                                      <label for="TipoUsuarioForm">Razon Social:</label>
                                                      <input type="text" class="form-control" placeholder="<% out.print(request.getAttribute("razonSocial")); %>" value="<%out.print(request.getAttribute("razonSocial"));%>" name="txtReasonSocial">
                                                   ...
                                                   <!-- <div class="form-group">
                                                    ...
                                                    <input type="hidden"  value="modificar" name="InputValue">
