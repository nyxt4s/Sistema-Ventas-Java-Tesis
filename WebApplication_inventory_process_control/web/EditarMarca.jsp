<%-- 
    ...
    Created on : 13-dic-2020, 18:50:40
    Author     : claud
--%>
...
<body>
    ...
    <%                //String IdTipoUsuario= request.getParameter("IdTipoUsuario");
                     ...
                     System.out.println("JSP EDITAR Categoria:");
                      System.out.println("id de Categoria:  "+request.getAttribute("idMarca"));
                        System.out.println("Nombre de Categoria  "+request.getAttribute("nombreMarca"));
            ...
            <div class="container-xl "  style="margin-top: 150px; border: 0px solid black;margin-left:50px;margin-right:50px; top: 500px;">
                ...
                <div class="row justify-content-md-center " id="Container"style="">
                    <div class="col-xl PanelHeader"  id="ContainerHeader" >
                        ...
                        <h4>Categoria a Editar: <%out.print(request.getAttribute("nombreMarca")); %></h4>
                         ...
                         <div class="row">
                                        <div class="col-lg-12">
                                            <div class="table-responsive">        
                                                ...
                                                <form  method="POST" action="/WebApplication_inventory_process_control/Marcas">
                                                    
                                                    
                                                     <div class="form-group">
                                                          <label for="TipoUsuarioForm">Identificador</label>
                                                          <input  class="form-control" value="<%out.print(request.getAttribute("idMarca"));%>" name="id" readonly>
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <input type="text" class="form-control" value="<% out.print(request.getAttribute("nombreMarca")); %>" placeholder="<% out.print(request.getAttribute("nombreMarca")); %>" name="txtNombreMarca">
