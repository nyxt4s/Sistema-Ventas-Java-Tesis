<%-- 
    ...
    Created on : 14-dic-2020, 12:22:26
    Author     : NYXTH
--%>
            ...
            <div class="container-xl "  style="margin-top: 150px; border: 0px solid black;margin-left:50px;margin-right:50px; top: 500px;">
                ...
                <div class="row justify-content-md-center " id="Container"style="">
                    <div class="col-xl PanelHeader"  id="ContainerHeader" >
                        ...
                        <h4>Producto a Editar: <%out.print(request.getAttribute("nombreProducto")); %></h4>
                         ...
                         <div class="row">
                                        <div class="col-lg-12">
                                            <div class="table-responsive">        
                                                ...
                                                <form  method="POST" action="/WebApplication_inventory_process_control/producto">
                                                    
                                                    
                                                     <div class="form-group">
                                                          <label for="TipoUsuarioForm">Identificador:</label>
                                                          <input  class="form-control" value="<%out.print(request.getAttribute("idProducto"));%>" name="id" readonly>
                                                          
                                                      </div>
                                                          
                                                    <div class="form-group">
                                                        
                                                      <label for="TipoUsuarioForm">Codigo de Barra:</label>
                                                        <input type="text" class="form-control " placeholder="<% out.print(request.getAttribute("CodigoBarraProducto")); %>" value="<% out.print(request.getAttribute("CodigoBarraProducto")); %>" name="txtCodigoBarra" >

                                                    </div>
                                                                                             
                                                    <div class="form-group">
                                                        
                                                      <label for="TipoUsuarioForm">Nombre:</label>
                                                      <input type="text" class="form-control" placeholder="<% out.print(request.getAttribute("nombreProducto")); %>" value="<% out.print(request.getAttribute("nombreProducto")); %>" name="txtNombre" >

                                                    </div>
                                                            
                                            <label for="validationCustom01" class="">Categoria:</label>
                                            <div class="input-group col-lg-12 alert alert-dark" >
                                        <input type="text" class="input-group-text col-lg-5" placeholder="nombre de la categoria:<% out.print(request.getAttribute("categoriaProducto")); %>" value="nombre de la categoria: <% out.print(request.getAttribute("categoriaProducto")); %>" name="categoria" readonly>
                                        ...
                                        <select class=" custom-select  col-lg-12 " aria-label=".form-select-lg example" name="txtCategoria">
                                                   <% Marca mac = new Marca();
                                                  LinkedList<Marca> listaMarca = Marca.getMarca();
                                                  LinkedList<Categoria> listaCategoria = Categoria.getCategory();
                                                  for (int x = 0; x < listaCategoria.size(); x++) {  
                                           out.println("<option value='"+listaCategoria.get(x).getIdcategoria()+"'>"+listaCategoria.get(x).getNombreCategoria()+"</option>"); }%>
                                            </select>
                                        ...
                                        <div class="input-group col-lg-12 alert alert-dark">
                                       <input type="text" class="input-group-text col-lg-5" placeholder="<% out.print(request.getAttribute("marcaProducto")); %>" value="nombre de la marca: <% out.print(request.getAttribute("marcaProducto")); %>" name="Marca" readonly>
                                   <div class="col-md-7 mb-3">
                                       
                                            <select class=" custom-select col-lg-12 " aria-label=".form-select-lg example " name="txtMarca">
                                           
                                              
                                             <%
                                         for (int x = 0; x < listaMarca.size(); x++) {  
                                       
                                           out.println("<option value='"+listaMarca.get(x).getIdMarca()+"'>"+listaMarca.get(x).getNombreMarca()+"</option>");
