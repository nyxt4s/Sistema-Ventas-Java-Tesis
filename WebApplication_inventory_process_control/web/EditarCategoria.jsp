<%-- 
    ...
    Created on : 12-dic-2020, 14:41:17
    Author     : NYXTH
--%>
            ...
            <div class="container-xl "  style="margin-top: 150px; border: 0px solid black;margin-left:50px;margin-right:50px; top: 500px;">
                ...
                <div class="row justify-content-md-center " id="Container"style="">
                    <div class="col-xl PanelHeader"  id="ContainerHeader" >
                        ...
                        <h4>Categoria a Editar: <%out.print(request.getAttribute("NombreCategoria")); %></h4>
                         ...
                         <div class="row">
                                        <div class="col-lg-12">
                                            <div class="table-responsive">        
                                                ...
                                                <form  method="POST" action="/WebApplication_inventory_process_control/categoria">
                                                    
                                                    
                                                     <div class="form-group">
                                                          <label for="TipoUsuarioForm">Identificador</label>
                                                          <input  class="form-control" value="<%out.print(request.getAttribute("idCategoria"));%>" name="id" readonly>
                                                          
                                                      </div>
                                                          
                                                    <div class="form-group">
                                                        
                                                      <label for="TipoUsuarioForm">Nombre de la Categoria:</label>
                                                      <input type="text" class="form-control" placeholder="<% out.print(request.getAttribute("NombreCategoria")); %>" value="<% out.print(request.getAttribute("NombreCategoria")); %>" name="txtEditarCategoria">
